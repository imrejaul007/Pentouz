...
import { ArrowLeft, ArrowRight, MapPin, Phone, Users, Coffee, Star, Utensils } from "lucide-react";
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 h-full flex flex-col justify-end items-end p-12">
                <div className="max-w-3xl">
                  ...
                  <p className="text-lg text-brand-accent mb-4">
                    Nestled in one of Bangalore's most upscale neighborhoods, offering tranquility with easy access to the city's vibrant offerings.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="lg:col-span-1">
                ...
                <div className="space-y-4">
                  <p className="text-base text-brand-body">
                    <strong>UB City & MG Road:</strong> 5-10 minutes by auto to premium shopping and dining.
                  </p>
                  <p className="text-base text-brand-body">
                    <strong>Cubbon Park:</strong> 15-minute drive for peaceful morning strolls.
                  </p>
                  <div className="mt-4">
                    <Link
                      href="https://maps.google.com/?q=${encodeURIComponent(indiranagar.address)}"
                      target="_blank"
              ...
              <div className="lg:col-span-1 bg-white border border-brand-border p-8">
                ...
                <p className="text-base text-brand-body">
                  100 Feet Road is lined with boutique cafes, upscale dining, and vibrant nightlife. A perfect blend of residential tranquility and urban accessibility in Bangalore's most sought-after address.
                </p>
              </div>
            </div>
          </div>
