...
import { ArrowRight, MapPin, Phone, Users, Navigation, Train, Car, Coffee } from "lucide-react";
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    { icon: MapPin, title: "Ooty Town Center", desc: "10 minutes by auto to main market area" },
                    { icon: Train, title: "Ooty Railway Station", desc: "15 minutes - board heritage Nilgiri Mountain Railway" },
                    { icon: Coffee, title: "Ooty Lake", desc: "3 km - popular for boating and evening walks" },
                  ].map((item, i) => (
      ...
      <section className="py-section-xl bg-white">
        <div className="max-w-container-xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { href: "/destinations/ooty/rooms", title: "Rooms", desc: "Choose your perfect room", image: "/ooty/bedroom-10.jpeg" },
