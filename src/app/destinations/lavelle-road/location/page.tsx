...
import { ArrowRight, MapPin, Phone, Users, Navigation, Train, Coffee, Building2 } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    { icon: Train, title: "MG Road Metro", desc: "1 km - connect across Bangalore effortlessly" },
                    { icon: Coffee, title: "Cubbon Park", desc: "15-minute walk for peaceful morning strolls" },
                  ].map((item, i) => (
            ...
            <div>
              ...
              <p className="text-body-lg text-brand-body leading-relaxed">
                Lavelle Road is one of Bangalore's most prestigious addresses. Tree-lined streets, boutique cafes, upscale dining, and proximity to cultural landmarks create the perfect urban retreat. The neighborhood offers a perfect blend of residential tranquility and urban accessibility.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-section-xl bg-brand-linen relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="https://maps.google.com/?q=46%206th%20Cross%2C%20Lavelle%20Road%2C%20Bangalore"
              target="_blank"
      ...
      <section className="py-section-xl bg-white">
        <div className="max-w-container-xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { href: "/destinations/lavelle-road/rooms", title: "Rooms", desc: "Six spacious studios", image: "/lavelle-road/king-suite-1.jpg" },
              { href: "/destinations/lavelle-road/experiences", title: "Experiences", desc: "Curated activities", image: "/lavelle-road/terrace-1.jpg" },
              { href: "/destinations/lavelle-road/gallery", title: "Gallery", desc: "Visual journey", image: "/lavelle-road/reception-1.jpg" },
            ].map((item, i) => (
              <Link
                key={i}
                href={item.href}
