...
import { ArrowRight, Plane, Train, MapPin } from "lucide-react";
...
const travelStats = [
  ...
  {
    title: "Chikmagalur Railway Station",
    distance: "12 kms",
    time: "30 min",
    icon: Train,
  ...
  {
    title: "Coffee Plantation Trails",
    distance: "Walk from property",
    time: "On-site",
    icon: MapPin,
    highlight: "Nature experience"
  },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-8 lg:gap-16 items-center">
              <div>
                ...
                <p className="font-['Lora',serif] text-sm text-[#4a4a44] leading-relaxed">
                  Nestled in the heart of Chikmagalur, the drive up through the Western Ghats is a treat in itself — winding roads flanked by coffee plantations and misty valleys.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                {travelStats.map((stat) => {
                  ...
                  return (
                    <div
                      key={stat.title}
                      className="relative group bg-[#f5f0e8] border border-[#e5dfd6] p-5 sm:p-6 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(18,15,12,0.08)] hover:border-[#c3a061]/30"
                    >
                      {/* Gold accent line */}
