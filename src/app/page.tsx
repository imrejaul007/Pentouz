...
// Simple ref setter (no animation state needed)
export default function HomePage() {
  ...
  return (
    <>
      <Header />
      <main className="bg-[#f6efe5] text-brand-ink">
          ...
          <div className="mx-auto flex min-h-[100svh] max-w-[1480px] flex-col justify-end px-5 pb-24 pt-48 sm:px-8 lg:px-14">
            <div className="grid gap-8 lg:grid-cols-[1fr_0.75fr] lg:items-end">
              <div className="max-w-5xl">
                <p className="text-[10px] uppercase tracking-[0.32em] text-brand-gold mb-4 animate-fade-in-up">The Pentouz</p>
                ...
                <p className="mt-6 text-base leading-7 text-white/74 max-w-2xl animate-fade-in-up [animation-delay:220ms]">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row animate-fade-in-up [animation-delay:320ms]">
                  <Link
                    href="/destinations"
                    className="inline-flex items-center justify-center gap-2 bg-white px-6 py-3 text-[11px] uppercase tracking-[0.18em] text-brand-ink transition-all duration-500 hover:bg-brand-gold hover:text-white"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center border border-white/20 px-6 py-3 text-[11px] uppercase tracking-[0.18em] text-white/88 transition-all duration-500 hover:border-brand-gold hover:text-brand-gold"
                  >
                    Speak to Concierge
                  </a>
                </div>
              ...
              <div className="animate-fade-in-up [animation-delay:420ms] xl:justify-self-end xl:max-w-[400px]">
                <div className="border-t border-white/20 pt-6 text-white">
                  <p className="text-[10px] uppercase tracking-[0.22em] text-brand-gold">Featured Property</p>
                  <h2 className="mt-3 font-display text-2xl font-light leading-tight text-white sm:text-3xl">
                    {lavelle.title}
                  </h2>
                  <p className="mt-4 text-sm leading-6 text-white/72">{lavelle.copy}</p>
                  <div className="mt-6 grid grid-cols-3 gap-4">
                    <div>
                      <p className="text-[9px] uppercase tracking-[0.18em] text-brand-gold">Location</p>
                      <p className="mt-1 text-xs text-white/84">Lavelle Road</p>
                    </div>
                    <div>
                      <p className="text-[9px] uppercase tracking-[0.18em] text-brand-gold">Setting</p>
                      <p className="mt-1 text-xs text-white/84">Boutique hotel</p>
                    </div>
                    <div>
                      <p className="text-[9px] uppercase tracking-[0.18em] text-brand-gold">Nearby</p>
                      <p className="mt-1 text-xs text-white/84">UB City, MG Road</p>
                    </div>
                  </div>
                  <div className="mt-6">
                    <Link href="/destinations/lavelle-road" className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-white transition-colors hover:text-brand-gold">
                      View Property
                      <ArrowRight className="h-4 w-4" strokeWidth={1.4} />
                    </Link>
                  </div>
        ...
        >
          ...
          <div className="mx-auto grid max-w-[1480px] gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[1fr_1fr] lg:gap-0 lg:px-14 lg:py-28">
            ...
            <div className="lg:pl-16 space-y-6 text-base leading-8 text-brand-body sm:text-lg">
              <p>
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {destinations.map((destination, index) => (
                <Link
                  ...
                  className="border-animate group overflow-hidden bg-white shadow-[0_24px_80px_rgba(18,15,12,0.06)] transition-all duration-700 hover:-translate-y-2"
                >
              ...
              <div className="group overflow-hidden border border-brand-border bg-[#f0e8d8] p-8 transition-all duration-700 hover:-translate-y-2">
              ...
              <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                {testimonials.map((testimonial, index) => (
                  <article
                    ...
                    className="group luxury-panel relative bg-white transition-all duration-1000 hover:-translate-y-1 hover:border-t-2 hover:border-brand-gold"
